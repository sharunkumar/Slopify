// https://github.com/tinybigideas/jGravity
/*
    ...
    jGravity: function (options) {
      ...
      return this.each(function () {
        ...
        $(o.target).each(function () {
          if (
            $(this).children().length < o.depth &&
            !$(this).hasClass(o.ignoreClass)
          ) {
            // filter by depth + ignoreClass
            $(this).addClass("box2d");
            $(this).css("zIndex", "999");
          }
        });
...
\*------------------------------------*/
        ...
        var Class = {
          create: function () {
            ...
            if (!c.prototype.initialize)
              c.prototype.initialize = this.emptyFunction;
        ...
        Object.extend(Object, {
          ...
          isArray: function (a) {
            return (
              a != null && typeof a == "object" && "splice" in a && "join" in a
            );
          },
          isHash: function (a) {
        ...
        if ((WebKit = navigator.userAgent.indexOf("AppleWebKit/") > -1)) {
          $A = function (a) {
            if (!a) return [];
            if (
              !(Object.isFunction(a) && a == "[object NodeList]") &&
              a.toArray
            )
              return a.toArray();
            var b = a.length || 0,
        ...
        b2Settings.b2_velocityThreshold =
          (1 * b2Settings.b2_lengthUnitsPerMeter) /
          b2Settings.b2_timeUnitsPerSecond;
        b2Settings.b2_maxLinearCorrection =
          0.2 * b2Settings.b2_lengthUnitsPerMeter;
        ...
        b2Pair.prototype = {
          ...
          IsBuffered: function () {
            return (
              (this.status & b2Pair.e_pairBuffered) == b2Pair.e_pairBuffered
            );
          },
          SetRemoved: function () {
        ...
        b2PairManager.prototype = {
          ...
          Commit: function () {
            ...
            for (a = 0; a < this.m_pairBufferCount; ++a) {
              ...
              if (d.IsRemoved()) {
                ...
                if (d.IsFinal() == false) {
                  d.userData = this.m_callback.PairAdded(
                    e.userData,
                    f.userData,
                  );
                  d.SetFinal();
          ...
          FindHash: function (a, b, c) {
            ...
            while (
              d != b2Pair.b2_nullPair &&
              b2PairManager.Equals(this.m_pairs[d], a, b) == false
            ) {
        ...
        b2BroadPhase.prototype = {
          ...
          GetProxy: function (a) {
            if (
              a == b2Pair.b2_nullProxy ||
              this.m_proxyPool[a].IsValid() == false
            ) {
              return null;
            }
        ...
        b2Collision.b2CollidePoly = function (a, b, c, d) {
          ...
          N = b2Collision.ClipSegmentToLine(
            L,
            q,
        ...
        b2Collision.b2CollidePolyAndCircle = function (a, b, c, d) {
          ...
          for (var p = 0; p < b.m_vertexCount; ++p) {
            var q =
              b.m_normals[p].x * (h - b.m_vertices[p].x) +
              b.m_normals[p].y * (i - b.m_vertices[p].y);
            if (q > o) {
              return;
            }
            if (q > n) {
          ...
          if (w < Number.MIN_VALUE) {
            ...
            a.pointCount = 1;
            a.normal.Set(
              j.col1.x * f + j.col2.x * g,
              j.col1.y * f + j.col2.y * g,
            );
            e = a.points[0];
        ...
        b2Shape.PolyMass = function (a, b, c, d) {
          ...
          for (var j = 0; j < c; ++j) {
            ...
            var x = o.y;
            var y =
              i * (0.25 * (u * u + w * u + w * w) + (s * u + s * w)) +
              0.5 * s * s;
            var z =
              i * (0.25 * (v * v + x * v + x * x) + (t * v + t * x)) +
              0.5 * t * t;
            g += p * (y + z);
          }
          a.mass = d * f;
              ...
              case b2Shape.e_circleShape:
                {
                  var b = this;
                  a.mass =
                    this.density * b2Settings.b2_pi * b.radius * b.radius;
                  a.center.Set(0, 0);
                  a.I = 0.5 * a.mass * b.radius * b.radius;
                }
                break;
              case b2Shape.e_boxShape:
                {
        ...
        Object.extend(b2CircleShape.prototype, {
          ...
          Synchronize: function (a, b, c, d) {
            this.m_R.SetM(d);
            this.m_position.x =
              d.col1.x * this.m_localPosition.x +
              d.col2.x * this.m_localPosition.y +
              c.x;
            this.m_position.y =
              d.col1.y * this.m_localPosition.x +
              d.col2.y * this.m_localPosition.y +
              c.y;
            if (this.m_proxyId == b2Pair.b2_nullProxy) {
              return;
            }
            var e =
              a.x +
              (b.col1.x * this.m_localPosition.x +
                b.col2.x * this.m_localPosition.y);
            var f =
              a.y +
              (b.col1.y * this.m_localPosition.x +
                b.col2.y * this.m_localPosition.y);
          ...
          Support: function (a, b, c) {
            ...
            b /= d;
            c.Set(
              this.m_position.x + this.m_radius * a,
              this.m_position.y + this.m_radius * b,
            );
          },
        ...
        Object.extend(b2PolyShape.prototype, {
          ...
          initialize: function (a, b, c) {
            ...
            if (a.type == b2Shape.e_boxShape) {
              ...
              this.m_localCentroid.x =
                a.localPosition.x + (i.col1.x * n + i.col2.x * o) - c.x;
              this.m_localCentroid.y =
                a.localPosition.y + (i.col1.y * n + i.col2.y * o) - c.y;
              for (d = 0; d < this.m_vertexCount; ++d) {
                ...
                this.m_coreVertices[d].x =
                  this.m_vertices[d].x - 2 * b2Settings.b2_linearSlop * p;
                this.m_coreVertices[d].y =
                  this.m_vertices[d].y - 2 * b2Settings.b2_linearSlop * q;
              }
            }
            var s = Number.MAX_VALUE;
            ...
            this.m_localOBB.center.Set((s + u) * 0.5, (t + v) * 0.5);
            this.m_localOBB.extents.Set((u - s) * 0.5, (v - t) * 0.5);
            var x = 0;
            var y = 0;
            for (d = 0; d < this.m_vertexCount; ++d) {
              ...
              this.m_normals[d].y = -(
                this.m_vertices[y].x - this.m_vertices[x].x
              );
          ...
          Synchronize: function (a, b, c, d) {
            ...
            this.m_position.x =
              this.m_body.m_position.x +
              (d.col1.x * this.m_localCentroid.x +
                d.col2.x * this.m_localCentroid.y);
            this.m_position.y =
              this.m_body.m_position.y +
              (d.col1.y * this.m_localCentroid.x +
                d.col2.y * this.m_localCentroid.y);
            if (this.m_proxyId == b2Pair.b2_nullProxy) {
              return;
            }
            var e;
          ...
          QuickSync: function (a, b) {
            ...
            this.m_position.x =
              a.x +
              (b.col1.x * this.m_localCentroid.x +
                b.col2.x * this.m_localCentroid.y);
            this.m_position.y =
              a.y +
              (b.col1.y * this.m_localCentroid.x +
                b.col2.y * this.m_localCentroid.y);
          },
          ResetProxy: function (a) {
            if (this.m_proxyId == b2Pair.b2_nullProxy) {
              return;
          ...
          Support: function (a, b, c) {
            ...
            for (var h = 1; h < this.m_vertexCount; ++h) {
              var i =
                this.m_coreVertices[h].x * d + this.m_coreVertices[h].y * e;
              if (i > g) {
                f = h;
                g = i;
              }
            ...
            c.Set(
              this.m_position.x +
                (this.m_R.col1.x * this.m_coreVertices[f].x +
                  this.m_R.col2.x * this.m_coreVertices[f].y),
              this.m_position.y +
                (this.m_R.col1.y * this.m_coreVertices[f].x +
                  this.m_R.col2.y * this.m_coreVertices[f].y),
            );
          },
        ...
        b2Body.prototype = {
          ...
          ApplyForce: function (a, b) {
            if (this.IsSleeping() == false) {
              ...
              this.m_torque += b2Math.b2CrossVV(
                b2Math.SubtractVV(b, this.m_position),
                a,
              );
            }
          },
          ...
          ApplyImpulse: function (a, b) {
            if (this.IsSleeping() == false) {
              ...
              this.m_angularVelocity +=
                this.m_invI *
                b2Math.b2CrossVV(b2Math.SubtractVV(b, this.m_position), a);
            }
          },
          GetMass: function () {
            return this.m_mass;
          ...
          GetLocalPoint: function (a) {
            return b2Math.b2MulTMV(
              this.m_R,
              b2Math.SubtractVV(a, this.m_position),
            );
          },
          ...
          initialize: function (a, b) {
            ...
            for (c = 0; c < this.m_shapeCount; ++c) {
              ...
              e = f[c];
              this.m_I += e.I;
              var g = b2Math.SubtractVV(
                b2Math.AddVV(d.localPosition, e.center),
                this.m_center,
              );
        ...
        b2CollisionFilter.prototype = {
          ShouldCollide: function (a, b) {
            ...
            var c =
              (a.m_maskBits & b.m_categoryBits) != 0 &&
              (a.m_categoryBits & b.m_maskBits) != 0;
            return c;
          },
          initialize: function () {},
        };
        ...
        b2Island.prototype = {
          ...
          Solve: function (a, b) {
            ...
            for (c = 0; c < this.m_bodyCount; ++c) {
              ...
              d.m_linearVelocity.Add(
                b2Math.MulFV(
                  a.dt,
                  b2Math.AddVV(b, b2Math.MulFV(d.m_invMass, d.m_force)),
                ),
              );
            ...
            if (b2World.s_enablePositionCorrection) {
              for (
                ...
                var g = e.SolvePositionConstraints(
          ...
          UpdateSleep: function (a) {
            ...
            for (b = 0; b < this.m_bodyCount; ++b) {
              ...
              if (
                (c.m_flags & b2Body.e_allowSleepFlag) == 0 ||
                c.m_angularVelocity * c.m_angularVelocity > f ||
                b2Math.b2Dot(c.m_linearVelocity, c.m_linearVelocity) > e
              ) {
                c.m_sleepTime = 0;
                d = 0;
              } else {
        ...
        b2Conservative.Conservative = function (a, b) {
          ...
          for (var F = 0; F < A; ++F) {
            ...
            if (F == 0) {
              ...
              var I =
                B * (f - i) + C * (g - j) + Math.abs(h) * l + Math.abs(k) * m;
        ...
        Object.extend(b2ContactManager.prototype, {
          ...
          PairAdded: function (a, b) {
            ...
            if (
              ...
              this.m_world.m_filter.ShouldCollide(c, d) == false
            ) {
              return this.m_nullContact;
            }
            if (f.m_invMass == 0) {
        ...
        b2World.prototype = {
          ...
          CreateJoint: function (a) {
            ...
            if (a.collideConnected == false) {
              var c =
                a.body1.m_shapeCount < a.body2.m_shapeCount ? a.body1 : a.body2;
        ...
        Object.extend(b2DistanceJoint.prototype, {
          ...
          PrepareVelocitySolver: function () {
            ...
            a = this.m_body1.m_R;
            var b =
              a.col1.x * this.m_localAnchor1.x +
              a.col2.x * this.m_localAnchor1.y;
            var c =
              a.col1.y * this.m_localAnchor1.x +
              a.col2.y * this.m_localAnchor1.y;
            a = this.m_body2.m_R;
            var d =
              a.col1.x * this.m_localAnchor2.x +
              a.col2.x * this.m_localAnchor2.y;
            var e =
              a.col1.y * this.m_localAnchor2.x +
              a.col2.y * this.m_localAnchor2.y;
            this.m_u.x =
              this.m_body2.m_position.x + d - this.m_body1.m_position.x - b;
            this.m_u.y =
              this.m_body2.m_position.y + e - this.m_body1.m_position.y - c;
            var f = Math.sqrt(
          ...
          SolveVelocityConstraints: function (a) {
            ...
            b = this.m_body1.m_R;
            var c =
              b.col1.x * this.m_localAnchor1.x +
              b.col2.x * this.m_localAnchor1.y;
            var d =
              b.col1.y * this.m_localAnchor1.x +
              b.col2.y * this.m_localAnchor1.y;
            b = this.m_body2.m_R;
            var e =
              b.col1.x * this.m_localAnchor2.x +
              b.col2.x * this.m_localAnchor2.y;
            var f =
              b.col1.y * this.m_localAnchor2.x +
              b.col2.y * this.m_localAnchor2.y;
            var g =
              this.m_body1.m_linearVelocity.x +
              -this.m_body1.m_angularVelocity * d;
            var h =
              this.m_body1.m_linearVelocity.y +
              this.m_body1.m_angularVelocity * c;
            var i =
              this.m_body2.m_linearVelocity.x +
              -this.m_body2.m_angularVelocity * f;
            var j =
              this.m_body2.m_linearVelocity.y +
              this.m_body2.m_angularVelocity * e;
        ...
        b2Jacobian.prototype = {
          ...
          Compute: function (a, b, c, d) {
            return (
              ...
              this.linear1.y * a.y +
              this.angular1 * b +
              (this.linear2.x * c.x + this.linear2.y * c.y) +
              this.angular2 * d
            );
          },
          initialize: function () {
        ...
        Object.extend(b2GearJoint.prototype, {
          ...
          PrepareVelocitySolver: function () {
            ...
            if (this.m_revolute1) {
              ...
              i = c.m_R;
              g =
                i.col1.x * this.m_localAnchor1.x +
                i.col2.x * this.m_localAnchor1.y;
              h =
                i.col1.y * this.m_localAnchor1.x +
                i.col2.y * this.m_localAnchor1.y;
              k = g * f - h * e;
            ...
            if (this.m_revolute2) {
              ...
              i = d.m_R;
              g =
                i.col1.x * this.m_localAnchor2.x +
                i.col2.x * this.m_localAnchor2.y;
              h =
                i.col1.y * this.m_localAnchor2.x +
                i.col2.y * this.m_localAnchor2.y;
              k = g * f - h * e;
              this.m_J.linear2.Set(-this.m_ratio * e, -this.m_ratio * f);
              this.m_J.angular2 = -this.m_ratio * k;
              l +=
                this.m_ratio * this.m_ratio * (d.m_invMass + d.m_invI * k * k);
            }
            this.m_mass = 1 / l;
            c.m_linearVelocity.x +=
              c.m_invMass * this.m_impulse * this.m_J.linear1.x;
            c.m_linearVelocity.y +=
              c.m_invMass * this.m_impulse * this.m_J.linear1.y;
            c.m_angularVelocity +=
              c.m_invI * this.m_impulse * this.m_J.angular1;
            d.m_linearVelocity.x +=
              d.m_invMass * this.m_impulse * this.m_J.linear2.x;
            d.m_linearVelocity.y +=
              d.m_invMass * this.m_impulse * this.m_J.linear2.y;
            d.m_angularVelocity +=
              d.m_invI * this.m_impulse * this.m_J.angular2;
          },
          SolveVelocityConstraints: function (a) {
            var b = this.m_body1;
            var c = this.m_body2;
            var d = this.m_J.Compute(
              b.m_linearVelocity,
              b.m_angularVelocity,
              c.m_linearVelocity,
              c.m_angularVelocity,
        ...
        Object.extend(b2MouseJoint.prototype, {
          ...
          initialize: function (a) {
            ...
            this.m_localAnchor.x =
              b * this.m_body2.m_R.col1.x + c * this.m_body2.m_R.col1.y;
            this.m_localAnchor.y =
              b * this.m_body2.m_R.col2.x + c * this.m_body2.m_R.col2.y;
          ...
          PrepareVelocitySolver: function () {
            ...
            b = a.m_R;
            var c =
              b.col1.x * this.m_localAnchor.x + b.col2.x * this.m_localAnchor.y;
            var d =
              b.col1.y * this.m_localAnchor.x + b.col2.y * this.m_localAnchor.y;
            var e = a.m_invMass;
            var f = a.m_invI;
            this.K1.col1.x = e;
            this.K1.col2.x = 0;
          ...
          SolveVelocityConstraints: function (a) {
            ...
            c = b.m_R;
            var d =
              c.col1.x * this.m_localAnchor.x + c.col2.x * this.m_localAnchor.y;
            var e =
              c.col1.y * this.m_localAnchor.x + c.col2.y * this.m_localAnchor.y;
        ...
        Object.extend(b2PrismaticJoint.prototype, {
          ...
          GetJointTranslation: function () {
            ...
            c = a.m_R;
            var d =
              c.col1.x * this.m_localAnchor1.x +
              c.col2.x * this.m_localAnchor1.y;
            var e =
              c.col1.y * this.m_localAnchor1.x +
              c.col2.y * this.m_localAnchor1.y;
            c = b.m_R;
            var f =
              c.col1.x * this.m_localAnchor2.x +
              c.col2.x * this.m_localAnchor2.y;
            var g =
              c.col1.y * this.m_localAnchor2.x +
              c.col2.y * this.m_localAnchor2.y;
            ...
            c = a.m_R;
            var n =
              c.col1.x * this.m_localXAxis1.x + c.col2.x * this.m_localXAxis1.y;
            var o =
              c.col1.y * this.m_localXAxis1.x + c.col2.y * this.m_localXAxis1.y;
            var p = n * l + o * m;
            return p;
          },
          ...
          GetReactionForce: function (a) {
            ...
            var d =
              b *
              (c.col1.x * this.m_localXAxis1.x +
                c.col2.x * this.m_localXAxis1.y);
            var e =
              b *
              (c.col1.y * this.m_localXAxis1.x +
                c.col2.y * this.m_localXAxis1.y);
            var f =
              b *
              (c.col1.x * this.m_localYAxis1.x +
                c.col2.x * this.m_localYAxis1.y);
            var g =
              b *
              (c.col1.y * this.m_localYAxis1.x +
          ...
          initialize: function (a) {
            ...
            this.m_localAnchor1.Set(
              c * b.col1.x + d * b.col1.y,
              c * b.col2.x + d * b.col2.y,
            );
            b = this.m_body2.m_R;
          ...
          PrepareVelocitySolver: function () {
            ...
            c = a.m_R;
            var l =
              c.col1.x * this.m_localYAxis1.x + c.col2.x * this.m_localYAxis1.y;
            var m =
              c.col1.y * this.m_localYAxis1.x + c.col2.y * this.m_localYAxis1.y;
          ...
          SolveVelocityConstraints: function (a) {
            ...
            var g = c.m_invI;
            var h;
            var i = this.m_linearJacobian.Compute(
              b.m_linearVelocity,
              b.m_angularVelocity,
              c.m_linearVelocity,
              c.m_angularVelocity,
            ...
            if (
              ...
              var p = this.m_motorJacobian.Compute(
                b.m_linearVelocity,
                b.m_angularVelocity,
                c.m_linearVelocity,
                c.m_angularVelocity,
          ...
          SolvePositionConstraints: function () {
            ...
            if (
              ...
              i = c.m_R;
              var B =
                i.col1.x * this.m_localXAxis1.x +
                i.col2.x * this.m_localXAxis1.y;
              var C =
                i.col1.y * this.m_localXAxis1.x +
                i.col2.y * this.m_localXAxis1.y;
              var D = B * r + C * s;
              var E = 0;
              if (this.m_limitState == b2Joint.e_equalLimits) {
                a = b2Math.b2Clamp(
            ...
            return (
              x <= b2Settings.b2_linearSlop && A <= b2Settings.b2_angularSlop
            );
          },
          m_localAnchor1: new b2Vec2(),
          m_localAnchor2: new b2Vec2(),
        ...
        Object.extend(b2PulleyJoint.prototype, {
          ...
          initialize: function (a) {
            ...
            this.m_groundAnchor1.x =
              a.groundPoint1.x - this.m_ground.m_position.x;
            this.m_groundAnchor1.y =
              a.groundPoint1.y - this.m_ground.m_position.y;
            this.m_groundAnchor2.x =
              a.groundPoint2.x - this.m_ground.m_position.x;
            this.m_groundAnchor2.y =
              a.groundPoint2.y - this.m_ground.m_position.y;
            b = this.m_body1.m_R;
            c = a.anchorPoint1.x - this.m_body1.m_position.x;
            d = a.anchorPoint1.y - this.m_body1.m_position.y;
            this.m_localAnchor1.x = c * b.col1.x + d * b.col1.y;
            ...
            var g = b2Math.b2Max(0.5 * b2PulleyJoint.b2_minPulleyLength, e);
            var h = b2Math.b2Max(0.5 * b2PulleyJoint.b2_minPulleyLength, f);
            ...
            this.m_maxLength2 = b2Math.b2Clamp(
              a.maxLength2,
              h,
              (this.m_constant - b2PulleyJoint.b2_minPulleyLength) /
                this.m_ratio,
            );
          ...
          PrepareVelocitySolver: function () {
            ...
            var t =
              (-this.m_pulleyImpulse - this.m_limitImpulse1) * this.m_u1.x;
            var u =
              (-this.m_pulleyImpulse - this.m_limitImpulse1) * this.m_u1.y;
            var v =
          ...
          SolveVelocityConstraints: function (a) {
            ...
            d = b.m_R;
            var e =
              d.col1.x * this.m_localAnchor1.x +
              d.col2.x * this.m_localAnchor1.y;
            var f =
              d.col1.y * this.m_localAnchor1.x +
              d.col2.y * this.m_localAnchor1.y;
            d = c.m_R;
            var g =
              d.col1.x * this.m_localAnchor2.x +
              d.col2.x * this.m_localAnchor2.y;
            var h =
              d.col1.y * this.m_localAnchor2.x +
              d.col2.y * this.m_localAnchor2.y;
            var i;
            var j;
            var k;
            var l;
            ...
            q =
              -(this.m_u1.x * i + this.m_u1.y * j) -
              this.m_ratio * (this.m_u2.x * k + this.m_u2.y * l);
        ...
        Object.extend(b2RevoluteJoint.prototype, {
          ...
          GetJointSpeed: function () {
            return (
              this.m_body2.m_angularVelocity - this.m_body1.m_angularVelocity
            );
          },
          ...
          SolveVelocityConstraints: function (a) {
            ...
            if (
              ...
              var n =
                c.m_angularVelocity - b.m_angularVelocity - this.m_motorSpeed;
              var o = -this.m_motorMass * n;
              var p = this.m_motorImpulse;
              this.m_motorImpulse = b2Math.b2Clamp(
                this.m_motorImpulse + o,
          ...
          SolvePositionConstraints: function () {
            ...
            f = c.m_R;
            var g =
              f.col1.x * this.m_localAnchor1.x +
              f.col2.x * this.m_localAnchor1.y;
            var h =
              f.col1.y * this.m_localAnchor1.x +
              f.col2.y * this.m_localAnchor1.y;
            f = d.m_R;
            var i =
              f.col1.x * this.m_localAnchor2.x +
              f.col2.x * this.m_localAnchor2.y;
            var j =
              f.col1.y * this.m_localAnchor2.x +
              f.col2.y * this.m_localAnchor2.y;
            ...
            return (
              e <= b2Settings.b2_linearSlop && w <= b2Settings.b2_angularSlop
            );
          },
          m_localAnchor1: new b2Vec2(),
          m_localAnchor2: new b2Vec2(),
...
\*------------------------------------*/
        ...
        function loop() {
          ...
          for (i = 0; i < elements.length; i++) {
            ...
            element.style.left =
              body.m_position0.x - (properties[i][2] >> 1) + "px";
            element.style.top =
              body.m_position0.y - (properties[i][3] >> 1) + "px";
